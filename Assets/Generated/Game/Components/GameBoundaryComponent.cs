...
public partial class GameEntity {
    ...
    public void AddBoundary(UnityEngine.Vector3 newMinBounds, UnityEngine.Vector3 newMaxBounds) {
        var index = GameComponentsLookup.Boundary;
        var component = (BoundaryComponent)CreateComponent(index, typeof(BoundaryComponent));
        component.minBounds = newMinBounds;
        component.maxBounds = newMaxBounds;
        AddComponent(index, component);
    }

    public void ReplaceBoundary(UnityEngine.Vector3 newMinBounds, UnityEngine.Vector3 newMaxBounds) {
        var index = GameComponentsLookup.Boundary;
        var component = (BoundaryComponent)CreateComponent(index, typeof(BoundaryComponent));
        component.minBounds = newMinBounds;
        component.maxBounds = newMaxBounds;
